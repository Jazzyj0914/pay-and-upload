...
<body>
    ...
    <script>
        ...
        function processPaymentAndUpload(videoUrl, paymentAmount) {
            ...
            // Redirect to the "watch" page after payment
...
<body>
    ...
    <p>
        <a href="watch-and-earn.html">Watch and Earn</a>
    </p>
    ...
    <script>
        ...
        function processPaymentAndUpload(videoUrl, paymentAmount) {
            ...
            // Redirect to the "watch" page after payment
            window.location.href = 'watch-and-earn.html?videoUrl=' + encodeURIComponent(videoUrl);
        }
    </script>
</body>
</html>
